...
def test_no_name():
    ...
    assert (not venue1.manageEvent(event1, None, valid_datetime, "Start worrying.") and
            event1.name == "Happy Time" and
            event1.datetime == valid_date_new and
            event1.desc == "Don't worry.")
...
def test_no_date():
    ...
    assert (not venue1.manageEvent(event1, "I'm not cramming!", None, "Start worrying.") and
            event1.name == "Happy Time" and
            event1.datetime == valid_date_new and
            event1.desc == "Don't worry.")
...
def test_old_date():
    ...
    assert (not venue1.manageEvent(event1, "I'm not cramming!", invalid_datetime, "Start worrying.") and
            event1.name == "Happy Time" and
            event1.datetime == valid_date_new and
            event1.desc == "Don't worry.")
